...
#ifndef CONNMANAGENTADAPTOR_H
#define CONNMANAGENTADAPTOR_H
 ...
 */
class ConnmanAgentAdaptor: public QDBusAbstractAdaptor
{
    Q_OBJECT
...
"  </interface>\n"
        "")
public:
    ConnmanAgentAdaptor(QObject *parent);
    virtual ~ConnmanAgentAdaptor();
